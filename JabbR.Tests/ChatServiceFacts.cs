    ...
    public class ChatServiceFacts
    {
        ...
        public class AddRoom
        {
            ...
            public void ThrowsIfRoomNameIsLobby()
            {
                ...
                repository.Add(user);
                var service = new ChatService(new Mock<ICache>().Object, new Mock<IRecentMessageCache>().Object, repository, new Mock<IChatServiceProxy>().Object);
            ...
            public void ThrowsIfRoomCreationDisabledAndNotAdmin()
            {
                ...
                var service = new ChatService(new Mock<ICache>().Object, new Mock<IRecentMessageCache>().Object, repository, new Mock<IChatServiceProxy>().Object, settings);
